...
Another feature is to see more details about each property, for example, its description, price, picture, location, and telephone number for contact.

For better UX, a functionality exists to save and store individual properties into a list and display them on another "Favorites" view page.

Finally, there is a built-in error handling (in case of network error for example, or if no search results are found)
  
## 📺Live Demonstrations
<div>
  <img src="demo1.gif" style="width: 60%; float: right" alt="A GIF image displaying the app's main functionality"  /> 
  <img src="demo2.gif" style="width: 60%; float: right" alt="A GIF image displaying the app's other functionalities"  /> 
</div>
